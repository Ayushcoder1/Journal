...
export default function ProfileDropdown() {
    ...
    return <div className="bg-white rounded-md">
        <div onClick={() => navigate('/account/profile')} className="relative border-b-2 border-zinc-200 p-4 w-55 m-2 hover:cursor-pointer">
        ...
        <div onClick={() => navigate('/account/stories')} className="relative border-b-2 border-zinc-200 p-4 w-55 m-2 hover:cursor-pointer">
            <button className="pl-10 text-xl text-zinc-400 font-mono font-semibold">Stories</button>
        ...
        <div onClick={() => navigate('/user/login')} className="relative border-b-2 border-zinc-200 p-4 w-55 m-2 hover:cursor-pointer">
            <button className="pl-10 text-xl text-zinc-400 font-mono font-semibold">Logout</button>
            <p></p>
        </div>
    </div>
}